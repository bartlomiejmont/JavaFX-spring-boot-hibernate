...
public class AdminViewService {
    ...
    public void openTabPaneViewModal(ActionEvent actionEvent, String viewPath) throws IOException {
    ...
    public void openPaneViewModal(ActionEvent actionEvent, String viewPath) throws IOException {
        Stage primaryStage = (Stage) ((Node) actionEvent.getSource()).getScene().getWindow();
